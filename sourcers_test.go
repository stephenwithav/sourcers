	...
	t.Log("Given the need to parse basic configuration.")
	{
		for i, tt := range tests {
			t.Logf("\tTest: %d\tWhen checking with arguments %v", i, tt.args)
			{
				...
				jsonSourcer, _ := sourcers.NewSourceJSON(tt.json)
	...
	t.Log("Given the need to parse basic configuration.")
	{
		for i, tt := range tests {
			t.Logf("\tTest: %d\tWhen checking with arguments %v", i, tt.args)
			{
				...
				yamlSourcer, _ := sourcers.NewSourceYAML(tt.YAML)
	...
	t.Log("Given the need to parse basic configuration.")
	{
		for i, tt := range tests {
			t.Logf("\tTest: %d\tWhen checking with arguments %v", i, tt.args)
			{
				...
				tomlSourcer, _ := sourcers.NewSourceTOML(tt.TOML)
